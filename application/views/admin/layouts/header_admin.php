...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url().'public/admin/content.css' ?>">
  <!-- Google Font -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
  <link rel="stylesheet" href="<?php echo base_url().'public/admin/form_add.css' ?>">
  <link rel="stylesheet" href="<?php echo base_url().'public/admin/list_product.css' ?>">
</head>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="dist/img/user3-128x128.jpg" class="img-circle" alt="">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="dist/img/user4-128x128.jpg" class="img-circle" alt="">
                      </div>
                      <h4>
                        Developers
