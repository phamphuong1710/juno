...
<div class="container">
	<div class="col-md-7 col-md-offset-3">
		<form action="addProduct" method="POST" role="form" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					<input type="text" class="form-control"  placeholder="ID danh mục sản phẩm" name="id_danhmucsanpham">
				</div>
			</div>
			<div class="form-group">
				<label class="col-xs-3 col-sm-3 col-md-3 col-lg-3">	
			...
			<div class="form-group">
				...
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					<input type="text" class="form-control"  placeholder="Kiểu dáng" name="kieudang">
				</div>
			</div>
			<div class="form-group">
				<label class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
				...
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					<input type="text" class="form-control"  placeholder="Chất liệu" name="chatlieu">
				</div>
			</div>
			<div class="form-group">
				<label class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
				...
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					<input type="text" class="form-control"  placeholder="Màu sắc" name="mausac">
				</div>
			</div>
			<div class="form-group">
				<label class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
				...
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					<input type="text" class="form-control"  placeholder="Kích cỡ" name="kichco">
				</div>
			</div>
			<div class="form-group">
				<label class="col-xs-3 col-sm-3 col-md-3 col-lg-3">ID nhà cung cấp</label>
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					<input type="text" class="form-control"  placeholder="ID nhà cung cấp" name="idnhacungcap">
				</div>
			</div>
			<div class="form-group">
				<label class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
			...
			<div class="form-group">
				...
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					<input type="text" class="form-control"  placeholder="Top" name="top">
				</div>
			</div>
