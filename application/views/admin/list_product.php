<?php
	$this->load->view('admin/head_list');
				            ...
				            <table id="bootstrap-data-table" class="table table-striped table-bordered">
				                ...
				                <tbody>
				                	<?php foreach ($product as $key => $value) {?>
					                  	<tr >
						                    <td>
						                    	<img src="<?php echo base_url().'image/'.$value->masanpham.'/'.$value->anhsanpham ?>" height="80">
						                    </td>
						                    
						                    <td>
						                    	<?php echo $value->masanpham; ?>
						                    </td>
						                    <td>
						                    	<?php echo $value->id_danhmucsanpham; ?>
						                    </td>
						                    <td>
						                    	<?php echo $value->gianhap; ?>
						                    </td>
						                    <td>
						                    	<?php echo $value->giaban; ?>
						                    </td>
						                    
						                    <td>
						                    	<?php echo $value->chatlieu; ?>
						                    </td>
						                    <td>
						                    	<?php echo $value->kichco; ?>
						                    </td>
						                    <td >
